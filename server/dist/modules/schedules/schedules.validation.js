...
exports.createScheduleSchema = zod_1.z.object({
    ...
    start_at: zod_1.z.string().datetime('Invalid datetime format').min(new Date().toISOString(), 'Start time must be in the future'),
    end_at: zod_1.z.string().datetime('Invalid datetime format').min(new Date().toISOString(), 'End time must be in the future'),
